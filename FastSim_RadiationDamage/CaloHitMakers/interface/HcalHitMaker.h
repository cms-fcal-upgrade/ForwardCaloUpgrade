...
class HcalHitMaker : public CaloHitMaker
{
 public:
  ...
  //get point in global coords
  XYZPoint getPoint(double r, double phi, unsigned layer);
  ...
  // get HcalDetId from point in global coords
  HcalDetId getDetId(const XYZPoint& point, unsigned layer);
