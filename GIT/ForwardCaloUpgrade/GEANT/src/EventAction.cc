...
//-----------------------------
  ...
  dECellsHcal  = new G4double[nHcalCells];
  dEHitsHcal  = new G4double[nRtot*nRtot];
...
// initialisation per event
  ...
  for (G4int i=0; i<nHcalCells; ++i) { dECellsHcal[i] = 0.; }
...
// fill Hcal cells energy
//------------------------
  myana->FillHCells(nHcalCells,dECellsHcal);   
...
//-------------------------
  ...
  delete dECellsHcal;
  delete dEHitsEcal;
  G4cout << "done with EventAction" << G4endl;  //AKA
