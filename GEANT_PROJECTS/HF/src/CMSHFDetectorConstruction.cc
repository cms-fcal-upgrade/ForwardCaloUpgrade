...
void CMSHFDetectorConstruction::ClearPhysicalVolumes()
{
  ...
  for ( unsigned i=0; i != nFibs; i++ ) {
    ...
    m_bufferCher[i]->GetLogicalVolume()->RemoveDaughter(m_bufferCher[i]);
