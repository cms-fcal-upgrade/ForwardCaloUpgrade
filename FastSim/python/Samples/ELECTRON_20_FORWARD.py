...
fileName.extend([
    "rfio:/castor/cern.ch/cms/store/cmst3/user/mgouzevi/FCAL_UPGRADE/ELECTRON/20GEV/FORWARD/SinglePigun_FASTSIM_0.root",
    "rfio:/castor/cern.ch/cms/store/cmst3/user/mgouzevi/FCAL_UPGRADE/ELECTRON/20GEV/FORWARD/SinglePigun_FASTSIM_1.root",
