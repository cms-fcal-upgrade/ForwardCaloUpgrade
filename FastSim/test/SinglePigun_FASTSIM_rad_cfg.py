...
#-------------- Turn on radiation damage
# function: RadDamage(process, isDam, lumiTot, lumiInst)
# process is the current process (do not change this argument)
# isDam is a boolean flag to enable (True) or disable (False) radiation damage
# lumiTot is the total integrated luminosity in 1/fb
# lumiInst is the instantaneous luminosity in cm^(-2)*s^(-1)
#---------------

from ForwardCaloUpgrade.FastSim.RadDamage_cff import RadDamage
RadDamage(process,False,500,5.0e+34)
