...
class BatchManager:
    ...
    def DefineOptions(self):
        ...
        self.parser_.add_option("-r", "--remote-copy", dest="remoteCopy",
                          help="remote or local output directory for your jobs, and file to be copied. Example: /castor/cern.ch/user/c/cbern/truc.root: for job 1, the file truc.root will be copied to /castor/cern.ch/user/c/cbern/truc_1.root or local absolute path can be used",
                          default="")
