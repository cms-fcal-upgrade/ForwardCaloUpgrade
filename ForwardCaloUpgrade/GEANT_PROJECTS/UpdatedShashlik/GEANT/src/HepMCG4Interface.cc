...
//
//   HepMCG4Interface.cc
//   $Id: HepMCG4Interface.cc,v 1.1 2012/10/01 15:21:16 andreevv Exp $
//
// ====================================================================
...
////////////////////////////////////////////////////////////////
{
  for(HepMC::GenEvent::vertex_const_iterator vitr= hepmcevt->vertices_begin();
    ...
    // G4int* b_code = new G4int( (*vitr)->barcode() );  //AKA  
    // g4vtx->SetUserInformation( (G4VUserPrimaryVertexInformation*) b_code );  //AKA


    G4UserPrimaryVertexAddendum* b_code = new G4UserPrimaryVertexAddendum();
    b_code->SetBarcode( (*vitr)->barcode() );

    //G4cout << b_code->GetBarcode() << G4endl;

    g4vtx->SetUserInformation( b_code );
	...
	new G4PrimaryParticle(pdgcode, p.x()*GeV, p.y()*GeV, p.z()*GeV, p.e()*GeV);
  ...
  //G4cout << "end of event conversion to G4event" << G4endl;
} 
