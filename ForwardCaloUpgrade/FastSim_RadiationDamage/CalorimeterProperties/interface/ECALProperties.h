...
class ECALProperties : public CalorimeterProperties 
{
 ...
 ///Photostatistics (photons/GeV) in the homegeneous material
  ...
  virtual double lightCollectionEfficiency(double eta) const=0;

  ///Light Collection uniformity
  virtual double lightCollectionUniformity(double eta) const=0;

  ///Light Collection non-linearity
  virtual double lightCollectionNonLinearity(double eta, double e) const=0;
