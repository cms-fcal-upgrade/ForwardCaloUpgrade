...
public:
  ...
  void fillHcalCell(G4int Lcell, G4double dEstep) {dECellsHcal[Lcell] += dEstep;};

  void fillHcalHits(G4int Lhits, G4double dEstep) {dEHitsHcal[Lhits] += dEstep;};
...
private:
   ...
   G4double    *dECellsHcal, *dEHitsHcal;
   G4int       printModulo;                     
   G4int       evtNbOld;
   G4int       RecVtxOpt;
